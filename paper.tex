...
\textcolor{blue}{Definition of what could be optimized (path length, execution time, number of via points, ...}
...
be traveled along. We choose $\alpha_{init} = 0.2$ or 0.05 to process small steps.
