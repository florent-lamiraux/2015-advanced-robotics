...
each of the two waypoints and $\beta$. This stage \textcolor{blue}{is performed by \texttt{computeCollisionConstraint}}.
...
\begin{figure}
	...
	$(\velocity_{\po_2/\body_1}(\xx_{Free})|\mathbf{u})=0$ is considered, so $\p$ already complies 
