...
$$
where $\po_1$ and $\po_2$ are computed in the configuration $\conf$. The function $g$ 
...
$$
\frac{\partial \conf}{\partial t}(t) = \alpha_i \frac{\partial f}{\partial \xx}(\xx_i + t\alpha_i\xx_{i+1})\p_i
$$
